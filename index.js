      ...
      case Enums.FOODOPT:
        {
          ...
          get_cache_header.url =
            "http://localhost:8080/food/search/foodoptionRepository/" +
            get_cache_header.params.id;
          post_cache_header.url = "http://localhost:8080/food/postoptionfood";

          service.getFoodOptionsCache(
            options,
            message,
            get_cache_header,
            post_cache_header,
      ...
      case Enums.FOODINST:
        {
          ...
          get_cache_header.params.id = args[0];
          get_cache_header.url =
            "http://localhost:8080/food/search/foodRepository/" +
            get_cache_header.params.id;
          ...
          if (CMD_NAME.toLowerCase() == Enums.FOODDESC) {
            ...
            service.getDescriptionByFoodCache(
              options,
              message,
              get_cache_header,
              post_cache_header,
            ...
            service.getInstructionsByFoodCache(
              options,
              message,
              get_cache_header,
              post_cache_header,
...
client.on("guildMemberAdd", (member) => {
  ...
  var channelid = member.guild.channels.cache.find(
